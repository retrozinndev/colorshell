// This module(src/overrides.ts) was pulled from Aylur/AGS, and is
// licensed with the same license as in its source(GPLv3).
// For the original module(lib/overrides.ts), please refer to the original repo:
// https://github.com/Aylur/ags
// Module(overrides.ts) permalink:
// https://github.com/Aylur/ags/blob/e169694390548dfd38ff40f1ef2163d6c3ffe3ea/lib/overrides.ts
